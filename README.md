...
`bge-m3:latest` unter `http://localhost:11434/api/embed`
konfiguriert.
...
```
cd existing_repo
git remote add origin https://gitup.uni-potsdam.de/medda1/wi-projekt-gruppe-2-sose-2026.git
git branch -M main
...
* [Set up project integrations](https://gitup.uni-potsdam.de/medda1/wi-projekt-gruppe-2-sose-2026/-/settings/integrations)
